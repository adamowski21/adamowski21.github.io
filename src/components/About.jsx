...
const About = () => {
  return (
    <section className="relative mt-72 mb-10">
      ...
      <h1 className="text-5xl text-center font-semibold mb-48">About Me</h1>
      <div className="flex flex-col md:flex-row gap-16 items-center">
        ...
        <div className="justify-center flex-col flex mx-4 md:mx-auto md:mr-40">
          <div className="gap-8 mb-8 mt-8 flex">
      ...
      <img
        src="arrow.png"
        alt="arrow icon"
        className="absolute -right-0 translate-y-80 mr-24 h-8 cursor-pointer lg:block hidden"
